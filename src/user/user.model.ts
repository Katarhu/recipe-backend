...
export const UserSchema = new mongoose.Schema<IUser>({
  ...
  savedDishes: { type: Map, of: { type: Number }, default: {}, required: true },
...
export const createUserJoi = Joi.object({
  username: Joi.string().required().messages(usernameValidationMessages),
  password: Joi.string().required().messages(passwordValidationMessages),
